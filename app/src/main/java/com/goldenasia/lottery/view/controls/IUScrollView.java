...
public class IUScrollView extends ScrollView {
	...
	public IUScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		onGlobalLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				contentView = (ViewGroup) IUScrollView.this.getChildAt(0);
				firstView = contentView.getChildAt(0);
				secondView = contentView.getChildAt(1);
				if (onGlobalLayoutListener != null) {
					IUScrollView.this.getViewTreeObserver()
							.removeGlobalOnLayoutListener(
									onGlobalLayoutListener);
					onGlobalLayoutListener = null;
					if (onGetHeightListener != null) {
						onGetHeightListener.onGetHeight(IUScrollView.this
								.getHeight());
					}
				}
			}
