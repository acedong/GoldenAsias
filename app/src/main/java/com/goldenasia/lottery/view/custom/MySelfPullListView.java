...
import com.goldenasia.lottery.util.DensityUtil;

public class MySelfPullListView extends ListView implements
	...
	public MySelfPullListView(Context paramContext) {
		super(paramContext);
		init(paramContext);
...
/*	public boolean onInterceptTouchEvent(MotionEvent ev) {
	...
	class ScalingRunnalable implements Runnable {
		...
		public void run() {
			...
			if ((!this.mIsFinished) && (this.mScale > 1.0D)) {
				...
				f2 = this.mScale - (this.mScale - 1.0F)
						* MySelfPullListView.sInterpolator.getInterpolation(f1);
				localLayoutParams = MySelfPullListView.this.mHeaderContainer
						.getLayoutParams();
				if (f2 > 1.0F) {
					Log.d("mmm", "f2>1.0");
					localLayoutParams.height = MySelfPullListView.this.mHeaderHeight;
					;
					localLayoutParams.height = ((int) (f2 * MySelfPullListView.this.mHeaderHeight));
					MySelfPullListView.this.mHeaderContainer
							.setLayoutParams(localLayoutParams);
					MySelfPullListView.this.post(this);
					return;
				}
				this.mIsFinished = true;
			}
		...
		public void startAnimation(long paramLong) {
			...
			this.mScale = ((float) (MySelfPullListView.this.mHeaderContainer
					.getBottom()) / MySelfPullListView.this.mHeaderHeight);
