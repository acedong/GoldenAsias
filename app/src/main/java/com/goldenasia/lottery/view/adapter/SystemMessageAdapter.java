...
import com.goldenasia.lottery.view.SystemMessageDetail;
...
public class SystemMessageAdapter  extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.nb_lottery_message_hall_system_item, null);	
			holder.messagetitle = (TextView) convertView.findViewById(R.id.nb_item_message_title);	//玩法logo
			holder.messagetime = (TextView) convertView.findViewById(R.id.nb_item_message_time);
		...
		holder.messagetitle.setText(messageData.getSubject());
		holder.messagetime.setText(messageData.getSendday());
		...
		holder.detailsbet.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				HallMiddleManager.getInstance().changeUI(SystemMessageDetail.class,bundle);
			}
		});
