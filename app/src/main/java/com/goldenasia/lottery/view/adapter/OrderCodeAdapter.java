...
public class OrderCodeAdapter extends BaseAdapter{
	...
	public OrderCodeAdapter(Context context,String[] code) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = listContainer.inflate(R.layout.nb_lottery_order_details_hall_gridview_item, null);
			holder.code = (TextView) convertView.findViewById(R.id.nb_lottery_order_details_hall_gridview_code);
