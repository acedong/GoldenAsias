...
import com.goldenasia.lottery.view.widget.NumericWheelAdapter;
import com.goldenasia.lottery.view.widget.OnWheelChangedListener;
...
public class SelectBirthday extends PopupWindow implements OnClickListener {
	...
	public SelectBirthday(Activity context) {
		...
		this.age = df.format(new Date());//"2012-9-25";   // new Date()为获取当前系统时间
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		mMenuView = inflater.inflate(R.layout.nb_component_dateselection, null);
	...
	private void updateDays(WheelView year, WheelView month, WheelView day) {
		...
		//Toast.makeText(mContext, age, Toast.LENGTH_LONG).show();
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.submit:
				onBtnClick.onClick(age);
			break;
		}
		this.dismiss();
	}
	
	public onBtnListenerClick onBtnClick;
	
	public onBtnListenerClick getOnBtnClick() {
		return onBtnClick;
	}

	public void setOnBtnClick(onBtnListenerClick onBtnClick) {
		this.onBtnClick = onBtnClick;
	}

	public interface onBtnListenerClick {
