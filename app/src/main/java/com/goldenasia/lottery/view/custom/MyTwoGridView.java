...
public class MyTwoGridView extends GridView {
	...
	public MyTwoGridView(Context context, AttributeSet attrs) {
		...
		// ③手指抬起
		// 修改手指下面的球的背景
		View view = View.inflate(context, R.layout.nb_gridview_two_item_pop, null);
		ball = (TextView) view.findViewById(R.id.nb_two_pretextView);
		...
		pop.setHeight(DensityUtil.dip2px(context, 39));
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		child = (TextView) this.findViewWithTag(position);// tag :唯一
	...
	private void updatePop(TextView child,int position) {
