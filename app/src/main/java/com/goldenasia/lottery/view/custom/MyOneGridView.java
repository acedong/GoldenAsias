...
public class MyOneGridView extends GridView {
	...
	public MyOneGridView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// ①手指按下
		// 显示放大的号码
		// ②手指滑动
		...
		View view = View.inflate(context, R.layout.nb_gridview_one_item_pop, null);
		ball = (TextView) view.findViewById(R.id.nb_one_pretextView);
		...
		pop.setWidth(DensityUtil.dip2px(context, 39));// dip--px
		pop.setHeight(DensityUtil.dip2px(context, 37));
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		TextView child = (TextView) this.findViewWithTag(position);// tag :唯一
