...
public class SampleListFragment extends ScrollTabHolderFragment{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mListView.setAdapter(new ArrayAdapter<String>(getActivity(), R.layout.fragment_list_item, android.R.id.text1, mListItems));
		
		if(FragmentUser.NEEDS_PROXY){//in my moto phone(android 2.1),setOnScrollListener do not work well
